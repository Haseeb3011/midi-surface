  ...
  pages: [
    {
      ...
      modules: [
        ...
        { id: 'mod-faders', type: 'faders', colSpan: 2 },
        { id: 'mod-wheels', type: 'wheels', colSpan: 2 },
  ...
  pages: [
    {
      ...
      name: 'Keys',
      modules: [
        { id: 'mod-keyboard-k', type: 'keyboard', colSpan: 4 },
        { id: 'mod-wheels-k', type: 'wheels', colSpan: 2 },
        { id: 'mod-knobs-k', type: 'knobs', colSpan: 2 },
        { id: 'mod-transport-k', type: 'transport', colSpan: 4 },
      ],
    },
  ],
};
